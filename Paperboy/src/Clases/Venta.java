...
public class Venta 
{
	...
	public Venta(int codigo, int cod_cliente, String fecha,int cod_mercaderia, int cantidad) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException, IOException {
		super();
		this.codigo = codigo;
